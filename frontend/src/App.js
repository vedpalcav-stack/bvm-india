...
{(type==='invoice'||type==='purchase_order'||type==='sales_order') &&
...
<div className="form-row">
    <label>Client's Ref / Quotation No.</label>
    <input
        value={form.client_quotation_number}
        onChange={e=>set(
