  ...
  return (
    <Modal title={`New ${label}`} onClose={onClose} extraWide>
      ...
      <div className="form-grid3 mb12">
        ...
        {(type==='invoice'||type==='purchase_order'||type==='sales_order') && <div className="form-row"><label>Due Date<<input type="date" value={form.due_date} onChange={e => set('due_date',e.target.value)}//label>></div>}
