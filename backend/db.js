...
process.env.DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres.kriqnuuspbgnkoxofnxz:Bvmindia9971@aws-1-ap-southeast-2.pooler.supabase.com:5432/postgres?sslmode=disable';
...
async function initDb() {
  ...
  if (Number(rows[0].c) === 0) {
    ...
    await pool.query(`
      INSERT INTO clients (id,name,contact,phone,email,gstin,address,city,state,pincode,type,balance) VALUES
        ('C001','Rajesh Traders Pvt Ltd','Rajesh Kumar','9876543210','rajesh@traders.in','27AABCT1332L1ZA','Shop 12, Trade Centre','Mumbai','Maharashtra','400069','Regular',45000),
        ('C002','Sharma Enterprises','Amit Sharma','9812345678','amit@sharma.in','07AAFCS2597P1Z6','B-42, Industrial Area','Delhi','Delhi','110020','Wholesale',-12000),
        ('C003','South Goods Co.','Priya Nair','9944332211','priya@southgoods.in','32AADCS1234K1ZB','MG Road, Fort Kochi','Kochi','Kerala','682001','Retail',0)
      ON CONFLICT (id) DO NOTHING;
    `);
    await pool.query(`
      INSERT INTO products (id,name,sku,category,hsn,unit,rate,gst) VALUES
        ('P001','Steel Pipe 1 inch','SP001','Steel','7304','Piece',850,18),
        ('P002','PVC Conduit 25mm','PC025','PVC','3917','Metre',45,18),
        ('P003','Cable 4mm 3Core','CB403','Cable','8544','Metre',120,18),
        ('P004','GI Wire 8 SWG','GW008','Steel','7217','Kg',75,18)
      ON CONFLICT (id) DO NOTHING;
    `);
    await pool.query(`
